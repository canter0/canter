  ...
  return (
    <AppShell active="System" context={`canter / default / ${name}`}>
      <section className="flex min-h-[calc(100vh-80px)] flex-col overflow-x-auto px-6 pt-10 sm:px-10 lg:px-14 lg:pt-11">
        <div className="grid min-w-[740px] items-end border-b border-[var(--rule-strong)] pb-7 lg:grid-cols-[1fr_170px_170px_170px]">
        ...
        <div className="mt-auto flex min-h-20 min-w-[740px] items-center justify-end border-t border-[var(--rule-strong)]"><Link href={`/app/system/${encodeURIComponent(name)}/policies`} className="rule-link">Standing policies ↗</Link></div>
      </section>
    </AppShell>
  );
}
