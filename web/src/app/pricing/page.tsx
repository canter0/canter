    ...
    <main className={styles.main}>
      ...
      <section id="compare" className={styles.compare} aria-labelledby="compare-title">
        ...
        <div className={styles.comparisonNotes}>
          <p>USD, before tax. Monthly figures use 720 hours. Compute scales in 1 vCPU / 1 GiB bundles, using the larger of allocated CPU or memory. Storage uses decimal GB. Storage rows compare object storage. Competitor prices checked September 15, 2026.</p>
